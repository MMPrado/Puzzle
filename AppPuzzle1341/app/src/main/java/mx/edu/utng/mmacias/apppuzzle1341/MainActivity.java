...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener,View.OnTouchListener{
    ...
    private int tipo;
    private int img;//imagen
    private PuzzleEstrategia juego;
    private ImageButton[] imagenes;
    private int disponible=15;//casilla disponoible (tipo1)
    private int pos1;//primera pieza seleccionada (tipo1)
    private int pos2;//segunda pieza seleccionada
    private boolean banPar=true; // se pulzaron 2 piezas
    private int x1; //coordenadas donde inicia el touch (tipo3)
    private int y1;
    private int x2;//coordenadas donde finaliza el touch
    private int y2;
    private int dxy; //direccion del desplazamiento
   ...
   // }
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        int dy=0;//desplazamineto vertical
        switch (view.getId()){
            case R.id.button1: pos1=1;break;
            case R.id.button2: pos1=2;break;
            case R.id.button3: pos1=3;break;
            case R.id.button4: pos1=4;break;
            case R.id.button5: pos1=5;break;
            case R.id.button6: pos1=6;break;
            case R.id.button7: pos1=7;break;
            case R.id.button8: pos1=8;break;
            case R.id.button9: pos1=9;break;
            case R.id.button10: pos1=10;break;
            case R.id.button11: pos1=11;break;
            case R.id.button12: pos1=12;break;
            case R.id.button13: pos1=13;break;
            case R.id.button14: pos1=14;break;
            case R.id.button15: pos1=15;break;
            case R.id.button16: pos1=16;break;
        ...
        switch (tipo){
            case 1: //Libre
                ...
                if (!banPar){//si es falsa
                    pos2=pos1;
                }else{// se selccionaron 2 piezas
                    juego.moverPieza(pos1,pos2);
                    moverImagenes(pos1,pos2);
                    if (juego.yaGano()){
                        Toast.makeText(getApplicationContext(),"Ganaste",Toast.LENGTH_LONG).show();//para mandar mensajes
                    }
            ...
            case 3:
                if(motionEvent.getAction()==MotionEvent.ACTION_DOWN){
                    x1=(int)motionEvent.getX();//obteninedo coordenadas
                    y1=(int)motionEvent.getY();//del inicio del touch
                }
                if (motionEvent.getAction()==MotionEvent.ACTION_UP) {
                    x2 = (int) motionEvent.getX();//obteninedo coordenadas
